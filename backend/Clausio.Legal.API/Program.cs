...
// AI
builder.Services.AddHttpClient<Clausio.Legal.Infrastructure.Ai.Providers.TokenRouterProvider>(c => c.Timeout = TimeSpan.FromSeconds(300));
builder.Services.AddHttpClient<Clausio.Legal.Infrastructure.Ai.Providers.OpenRouterProvider>(c => c.Timeout = TimeSpan.FromSeconds(300));
builder.Services.AddHttpClient<Clausio.Legal.Infrastructure.Ai.Providers.OpenAIEmbeddingProvider>(c => c.Timeout = TimeSpan.FromSeconds(120));
