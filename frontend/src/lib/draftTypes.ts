...
const DRAFT_TYPES_BY_CASE: Record<string, DraftType[]> = {
  ...
  // ── FAMILY LAW ──────────────────────────────────────────────
  family: [
    { label: 'Divorce Petition (Section 13 HMA)', description: 'Petition under Section 13 HMA for dissolution of marriage',      sections: ['Section 13 HMA', 'Section 13B HMA'] },
    { label: 'Maintenance (Section 24 HMA)',   description: 'Application for maintenance pendente lite under Section 24 HMA', sections: ['Section 24 HMA', 'Section 125 CrPC'] },
    { label: 'Permanent Alimony (Section 25 HMA)', description: 'Application for permanent alimony under Section 25 HMA',       sections: ['Section 25 HMA'] },
    { label: 'Child Custody Application',      description: 'Petition for custody of minor children',                          sections: ['Section 26 HMA', 'Guardians and Wards Act'] },
    { label: 'Restitution of Conjugal Rights', description: 'Petition under Section 9 HMA for restitution',                  sections: ['Section 9 HMA'] },
    { label: 'Domestic Violence Application (PWDVA)', description: 'Complaint under Protection of Women from DV Act 2005',     sections: ['Section 12 DV Act', 'Section 18 DV Act'] },
  ...
  // ── CRIMINAL LAW ────────────────────────────────────────────
  criminal: [
    { label: 'Bail Application (Sessions Court)', description: 'Regular bail application before Sessions Court under Section 437 CrPC', sections: ['Section 437 CrPC', 'Section 439 CrPC'] },
    { label: 'Bail Application (High Court)',  description: 'Regular bail application before High Court under Section 439 CrPC', sections: ['Section 439 CrPC'] },
    { label: 'Anticipatory Bail',             description: 'Application for anticipatory bail under Section 438 CrPC',       sections: ['Section 438 CrPC'] },
    ...
    { label: 'Criminal Revision',             description: 'Revision against interlocutory orders',                          sections: ['Section 397 CrPC', 'Section 401 CrPC'] },
    ...
    { label: 'Bail (NDPS Act)',               description: 'Bail application in NDPS cases — twin conditions under Section 37 NDPS Act', sections: ['Section 37 NDPS Act', 'Section 439 CrPC'] },
  ],

  // ── CIVIL LITIGATION ────────────────────────────────────────
  civil: [
    { label: 'Civil Plaint / Suit',           description: 'Institution of civil suit under Order VII CPC',                  sections: ['Order VII CPC', 'Section 26 CPC'] },
    { label: 'Written Statement',             description: 'Reply to plaint with defence and counter-claims',                 sections: ['Order VIII CPC'] },
    { label: 'Interim Injunction Application', description: 'Application for temporary injunction under Order XXXIX',         sections: ['Order XXXIX Rules 1-2 CPC', 'Section 151 CPC'] },
    ...
    { label: 'Declaratory Suit',              description: 'Suit for declaration under Section 34 Specific Relief Act 1963', sections: ['Section 34 Specific Relief Act 1963'] },
    { label: 'Partition Suit',                description: 'Suit for partition of joint family or co-owned property',        sections: ['Hindu Succession Act 1956'] },
  ],

  // ── GST ─────────────────────────────────────────────────────
  gst: [
    { label: 'GST Show Cause Notice Reply',   description: 'Detailed reply to SCN issued under Section 73/74 CGST Act',     sections: ['Section 73 CGST', 'Section 74 CGST'] },
    { label: 'GST Appeal',                    description: 'First appeal against adjudication order under Section 107',     sections: ['Section 107 CGST Act'] },
    { label: 'Stay Application',              description: 'Application for stay of recovery during appeal',                 sections: ['Section 107(7) CGST Act'] },
    { label: 'GST Writ Petition (Article 226)', description: 'Writ petition to High Court against unreasonable GST demand', sections: ['Article 226 Constitution'] },
  ...
  'income tax': [
    ...
    { label: 'Income Tax Appeal (CIT(A) / ITAT)', description: 'First appeal against assessment order under Section 246A',  sections: ['Section 246A IT Act'] },
  ...
  arbitration: [
    ...
    { label: 'Arbitration Section 9 (Interim Relief)', description: 'Application for interim relief before court under Section 9', sections: ['Section 9 A&C Act 1996'] },
    { label: 'Arbitration Section 34 (Set Aside Award)', description: 'Petition to set aside arbitral award under Section 34', sections: ['Section 34 A&C Act 1996'] },
...
const DEFAULT_DRAFT_TYPES: DraftType[] = [
  ...
  { label: 'Agreement / Contract', description: 'Draft any agreement or contract', sections: [] },
  { label: 'Legal Opinion',      description: 'Legal opinion on any matter of Indian law', sections: [] },
  { label: 'Notice / Show Cause Notice', description: 'Court notice or show cause notice', sections: [] },
]
