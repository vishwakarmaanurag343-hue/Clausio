...
function HowItWorksSection() {
 ...
 className="flex-1 bg-white rounded-2xl p-8 border-l-4 "
 ...
 <p className="mt-3 text-sm text-[#787774]" style={{ lineHeight: 1.7 }}>
 {step.desc}
 </p>
 </motion.div>
...
/* ============================================================= */
/* PRICING — monthly / annual toggle, two plans */
/* ============================================================= */
const PRICING_PLANS = [
  {
    name: "Beta Package",
...
function PricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="relative z-30 py-24 px-6 md:px-16 flex flex-col justify-center items-center font-sans"
    >
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center">
        
        <h2 className="text-4xl md:text-5xl tracking-tight text-[#111111] font-medium mb-10 text-center">
          Choose your plan
        </h2>

        {/* Monthly / Annual toggle - Brainwave style */}
        <div className="flex items-center bg-[#F3F4F6] rounded-full p-1 mb-16 shadow-inner border border-black/5">
          <button
            onClick={() => setIsAnnual(false)}
            className={`relative px-6 py-2.5 rounded-full text-sm font-medium transition-all ${
              !isAnnual ? "bg-white text-[#111111] shadow-sm" : "text-[#787774] hover:text-[#111111]"
            }`}
          >
            Pay monthly
          </button>
          ...
          >
            Pay yearly
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 absolute top-3 right-3 shadow-[0_0_8px_rgba(16,185,129,0.5)]"></span>
          </button>
        </div>
          ...
          {PRICING_PLANS.map((plan, idx) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: false }}
                className={`relative bg-white rounded-[32px] border border-[#E5E7EB] shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col overflow-hidden ${
                  featured ? "md:-mt-4 md:mb-[-1rem] shadow-[0_20px_40px_rgb(0,0,0,0.08)]" : ""
                }`}
              >
                {/* Featured Dark Banner Header */}
                {featured && (
                  <div className="h-32 w-full bg-gradient-to-br from-[#1F2937] via-[#111111] to-[#374151] px-8 pt-8 flex items-start">
                    <h3 className="text-2xl text-white font-medium">{plan.name}</h3>
                  </div>
                )}

                <div className={`p-8 flex flex-col h-full ${featured ? "pt-6" : ""}`}>
                  {!featured && (
                    <h3 className="text-2xl text-[#111111] font-medium mb-2">{plan.name}</h3>
                  )}
                  
                  <p className="text-sm text-[#787774] leading-relaxed min-h-[40px]">
                    {plan.description}
                  </p>

                  {/* Gray Inset Box for Price and CTA */}
                  <div className="mt-8 bg-[#F9FAFB] rounded-2xl p-6 border border-[#F3F4F6]">
                    <div className="flex items-baseline gap-2 mb-6">
                      <span className="text-[40px] font-medium text-[#111111] tracking-tight leading-none">
                        {price}
                      </span>
                      {price !== "Custom" && (
                         <div className="flex flex-col text-[10px] text-[#787774] font-medium uppercase leading-tight">
                           <span>USD /</span>
                           <span>month</span>
                         </div>
                      )}
                    ...
                    <button
                      onClick={() =>
                        window.open(
                          plan.comingSoon
                            ? `mailto:${SUPPORT_EMAIL}?subject=Early Access Request`
                      ...
                      className={`w-full py-3.5 rounded-xl text-sm font-medium transition-all duration-300 ${
                        featured
                          ? "bg-[#EAEAEA] text-[#111111] hover:bg-[#D1D1D1]"
                  ...
                  <ul className="mt-8 space-y-4 flex-1">
                    {plan.features.map((f) => (
                      <li key={f} className="flex items-start gap-3 text-sm text-[#111111]">
                        <Check className="w-4 h-4 text-[#111111] mt-0.5 shrink-0" strokeWidth={2.5} />
...
function CourtsMarquee() {
 const pill =
 "shrink-0 rounded-md bg-white border border-[#EAEAEA] px-4 py-1.5 text-xs font-medium text-[#787774] shadow-none";
 return (
 <section 
 className="relative z-30 bg-[#F9F9F8] border-y border-[#EAEAEA] py-12 overflow-hidden"
 style={{ WebkitMaskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)", maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}
 >
 <p className="text-[#787774] text-[11px] font-mono tracking-widest uppercase font-semibold text-center mb-8">
...
function TypewriterWindow() {
 ...
 <span className="w-2.5 h-2.5 rounded-xl" style={{ background: "#ff5f57" }} />
 <span className="w-2.5 h-2.5 rounded-xl" style={{ background: "#ffbd2e" }} />
 <span className="w-2.5 h-2.5 rounded-xl" style={{ background: "#28ca41" }} />
 </div>
...
function ProductDemo() {
 ...
 <div className="w-full xl:w-72 flex flex-col gap-2 shrink-0 bg-white p-4 rounded-2xl border border-slate-200 ">
 ...
 <span
 className="w-2.5 h-2.5 rounded-xl shrink-0 transition-transform duration-200"
 style={{
 ...
 <div className="ml-auto w-6 h-1.5 bg-slate-700 rounded-xl overflow-hidden shrink-0">
 <div
 ...
 className="p-1 rounded-md hover:bg-white text-[#787774] font-bold"
 title="Previous Feature"
 >
 ←
 </button>
 <span className="text-[11px] text-[#787774] font-bold px-1.5 font-mono">
 ...
 <div className="flex-1 bg-white rounded-2xl border border-slate-200 overflow-hidden flex flex-col relative min-h-[460px]">
 {/* Court Stamp Badge */}
 ...
 <div className="w-3 h-3 rounded-xl bg-rose-500/90" />
 <div className="w-3 h-3 rounded-xl bg-amber-500/90" />
 <div className="w-3 h-3 rounded-xl bg-[#EDF3EC]0/90" />
 </div>
 ...
 <div className="hidden sm:flex items-center gap-2 text-[10px] font-mono text-emerald-400 bg-emerald-950/60 border border-emerald-800/60 px-2.5 py-0.5 rounded-xl font-bold">
 <span className="w-1.5 h-1.5 rounded-xl bg-emerald-400" />
 ...
 <p className="text-xs sm:text-sm text-[#787774] max-w-xl leading-relaxed">
 {feature.description}
 </p>
 </div>
 </div>
 ...
 >
 <span className="text-xs font-medium text-[#787774]">{item.label}</span>
 <div className="flex items-baseline justify-between">
 <span className="text-2xl font-black font-mono" style={{ color: item.color }}>
 {item.value}
 </span>
 <span className="text-[10px] font-mono text-[#787774] bg-slate-100 px-1.5 py-0.5 rounded font-bold">
 {item.trend}
 </span>
 </div>
 </div>
 ...
 >
 <div className="flex items-center gap-2">
 <Gavel className="w-3.5 h-3.5 text-[#787774]" />
 ...
 : 'bg-white text-[#787774] border-slate-200 hover:border-purple-300'
 }`}
 >
 <span>{item.text}</span>
 <span className={`text-[9px] px-1.5 py-0.2 rounded uppercase ${selectedTemplate === i ? 'bg-purple-900 text-purple-100' : 'bg-slate-100 text-[#787774]'}`}>
 {item.tag}
 </span>
 </button>
 ))}
 ...
 <span className="text-[10px] text-[#787774]">Court Ready Format • Citation Verified</span>
 <button
 onClick={() => {
 setCopiedIndex(1);
 ...
 tab.active ? 'bg-cyan-700 text-white' : 'bg-slate-100 text-[#787774]'
 }`}
 >
 {tab.text}
 </span>
 ...
 <div className="flex items-center gap-1 text-[11px] font-mono text-[#346538] bg-[#EDF3EC] border border-emerald-200 px-2 py-0.5 rounded-xl font-bold">
 ...
 <span className="text-xs font-mono font-semibold text-[#787774] w-32">{item.label}</span>
 ...
 <span className="text-[10px] font-mono text-[#346538] bg-[#EDF3EC] px-2 py-0.5 rounded font-bold">
 5 Events Identified
 </span>
 </div>
 ...
 <div className="absolute -left-[25px] top-1.5 w-2.5 h-2.5 rounded-xl bg-emerald-600 border-2 border-white" />
 <div>
 <span className="font-mono text-[11px] font-bold text-[#346538]">{item.date}</span>
 <p className="text-slate-800 font-semibold">{item.event}</p>
 </div>
 <span className="text-[9px] font-mono font-bold uppercase px-2 py-0.5 rounded bg-[#EDF3EC] text-emerald-800 border border-emerald-200 shrink-0">
 {item.tag}
 </span>
 </div>
 ))}
 ...
 <div className="bg-[#EDF3EC]/70 border border-emerald-200 p-3 rounded-xl space-y-2">
 ...
 <span className="text-[10px] font-mono font-bold text-red-600 bg-[#FDEBEC] px-2 py-0.5 rounded border border-red-200">
 {item.citation}
 </span>
 </div>
 <p className="text-xs text-[#787774] mt-1 leading-snug">{item.relevance}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="bg-[#dcf8c6] p-3 rounded-2xl rounded-tr-none text-xs text-slate-900 font-sans leading-relaxed max-w-[90%] self-end">
 {(feature.mockup.find(m => m.type === 'message') as any)?.text}
 <div className="text-[9px] text-[#787774] font-mono text-right mt-1 flex items-center justify-end gap-1">
 <span>10:42 AM</span>
 ...
 <span className="text-[#787774]">Husband Net Income (Drag Slider):</span>
 ...
 <div className="flex justify-between text-xs font-medium">
 <span className="text-[#787774]">Wife Net Income:</span>
...
export default function LandingPageUI() {
 ...
 <header
 className={`pointer-events-auto flex items-center justify-between transition-all duration-500 rounded-xl ${
 isScrolled
 ? "w-full max-w-5xl px-7 py-3 minimal-nav"
 : "w-full max-w-6xl px-8 py-3 minimal-nav"
 }`}
 >
 {/* Logo / Brand Name */}
 ...
 alt="Clausio Logo"
 className="h-7 w-auto object-contain drop-"
 />
 <span className="text-xs tracking-[0.28em] uppercase font-mono font-bold text-[#231B15] ">
 CLAUSIO
 </span>
 </a>
 </div>
 ...
 <nav className="hidden lg:flex items-center space-x-9 text-[11px] uppercase tracking-[0.2em] font-mono font-medium text-[#4A3D33]">
 {[
 ...
 className={`relative py-1 transition-colors after:absolute after:left-0 after:-bottom-0.5 after:h-[2px] after:rounded-xl after:bg-[#0284C7] after:transition-all after:duration-300 ${
 isActive
 ...
 className="absolute top-[4vh] md:top-[6vh] lg:top-[7vh] w-[260px] md:w-[340px] lg:w-[400px] h-[260px] md:h-[340px] lg:h-[400px] rounded-xl pointer-events-none -z-10 flex items-center justify-center"
 >
 <div className="absolute inset-0 rounded-xl blur-[70px]" />
 <div className="w-3/4 h-3/4 rounded-xl blur-[45px]" />
 <div className="w-1/2 h-1/2 rounded-xl blur-[25px]" />
 </motion.div>
 ...
 className="relative z-10 h-[72vh] md:h-[80vh] lg:h-[84vh] max-w-none object-contain drop-"
 style={{
 ...
 <span
 key={i}
 className="absolute rounded-xl bg-[#2563eb]"
 style={{
 left: `${p.x}%`,
 top: `${p.y}%`,
 width: p.size,
 ...
 {/* Responsive Editorial Headline (Bottom-Center on Mobile/Tablet, Right-Aligned on Desktop) */}
 <motion.div
 style={{ opacity: textOpacity, y: textY }}
 className="absolute inset-x-0 bottom-10 lg:bottom-auto lg:top-[56%] lg:-translate-y-1/2 lg:right-16 xl:right-24 z-40 flex flex-col items-center lg:items-end text-center lg:text-right w-full lg:w-auto px-6 lg:px-0 pointer-events-none"
 >
 {/* Gradient fade on Mobile/Tablet to make text readable over the statue */}
 <div className="absolute inset-0 bg-gradient-to-t from-[#FBF9F6] via-[#FBF9F6]/80 to-transparent lg:hidden -z-10 blur-xl scale-125 translate-y-8" />
 <div className="absolute inset-0 bg-gradient-to-t from-[#FBF9F6] via-[#FBF9F6]/95 to-transparent lg:hidden -z-10 translate-y-12 scale-110" />

 {/* Skeuomorphic Embossed Tag */}
 <div className="flex items-center space-x-3 px-3 py-1 rounded-xl minimal-inset text-[9px] sm:text-[10px] md:text-[11px] font-mono uppercase tracking-[0.32em] font-semibold text-[#5A4839] mb-3 pointer-events-auto">
 ...
 className="text-[52px] sm:text-[64px] md:text-[84px] lg:text-[120px] xl:text-[142px] font-serif font-normal tracking-tight text-[#111111] leading-[0.84] select-none uppercase pointer-events-auto"
 >
 INDIAN
 </motion.h1>
 ...
 className="text-lg sm:text-2xl md:text-[40px] lg:text-5xl xl:text-6xl font-sans font-light tracking-widest uppercase text-[#3C2F25] leading-tight mt-1 md:mt-2 pointer-events-auto"
 >
 LITIGATION
 </motion.div>
 ...
 className="mt-6 p-4 rounded-xl minimal-bento-card max-w-xs md:max-w-sm text-center lg:text-right pointer-events-auto"
 >
 ...
 className="flex items-center justify-center lg:justify-end gap-0.5 mt-4 text-xs md:text-sm font-mono font-semibold text-[#0369A1] min-h-[22px] pointer-events-auto"
 >
 <span>{heroTyped}</span>
 ...
 className="flex items-center flex-wrap justify-center lg:justify-end gap-4 sm:gap-6 md:gap-8 mt-8 pt-5 border-t border-[#3A2E26]/15 pointer-events-auto"
 >
 {[
 ...
 <div key={i} className="flex flex-col items-center lg:items-end gap-0.5">
 <span className="text-lg sm:text-xl md:text-2xl font-mono font-extrabold text-[#111111] leading-none">
 {stat.number}
 </span>
 <span className="text-[8px] sm:text-[9px] md:text-[10px] font-mono font-semibold uppercase tracking-[0.12em] text-[#6B5A4B]">
 {stat.label}
 </span>
 </div>
 ))}
 ...
 >
 <span className="text-[10px] md:text-[11px] font-mono uppercase tracking-[0.25em] font-medium text-[#5C4D3F] ">
 SCROLL TO EXPLORE
 </span>
 <div className="hero-scroll-line w-12 h-[2px] rounded-xl bg-[#3A2E26]/30 " />
 </motion.div>
 </motion.div>
 </section>
 ...
 <div className="absolute left-[54%] top-[48vh] -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] rounded-xl blur-[120px] pointer-events-none -z-10" />
 ...
 {/* LEFT/BOTTOM: Enlarged, Dominant Laptop Visual */}
 <motion.div
 initial={{ opacity: 0, y: 40, scale: 0.98 }}
 whileInView={{ opacity: 1, y: 0, scale: 1.04 }}
 transition={{ duration: 0.9, ease: "easeOut" }}
 viewport={{ once: false, amount: 0.15 }}
 className="w-[85vw] sm:w-[70vw] md:w-[60vw] lg:w-[55vw] xl:w-[50vw] absolute bottom-[10vh] left-1/2 -translate-x-1/2 md:relative md:bottom-auto md:left-auto md:translate-x-0 pointer-events-auto flex items-center justify-center md:justify-start md:pl-8 lg:pl-10 xl:pl-12 md:translate-y-[-3.5vh] z-40"
 >
 <div
 className="relative w-full"
 style={{
 ...
 className="w-full h-auto max-h-[97vh] object-contain drop- origin-bottom-left"
 />
 </div>
 </motion.div>

 {/* CENTER: FROSTED GLASS SEARCH CAPSULE PILL (Litigation Platform) */}
 <motion.div
 initial={{ opacity: 0, scale: 0.92, y: 15 }}
 whileInView={{ opacity: 1, scale: 1, y: 0 }}
 transition={{ duration: 0.8, delay: 0.2 }}
 viewport={{ once: false }}
 className="absolute left-1/2 md:left-[54vw] top-[15vh] md:top-[48vh] -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-auto flex items-center justify-center select-none group"
 >
 {/* AI Glowing Aura (Animated) */}
 <div className="absolute -inset-1 rounded-xl ] ] ] blur-md opacity-50 group-hover:opacity-75 transition duration-1000 animate-pulse" />
 
 {/* Thin Glassmorphism Pill */}
 <div className="relative px-7 py-3 rounded-xl bg-[#0F172A]/40 border border-white/20 flex items-center space-x-3">
 {/* AI Pulse Indicator Dot */}
 <div className="relative flex h-2.5 w-2.5">
 <span className="animate-ping absolute inline-flex h-full w-full rounded-xl bg-[#4ADE80] opacity-75"></span>
 <span className="relative inline-flex rounded-xl h-2.5 w-2.5 bg-[#4ADE80] "></span>
 </div>

 <span className="text-xs md:text-sm font-sans font-medium tracking-[0.06em] text-white whitespace-nowrap drop-">
 Litigation Platform
 </span>
 </div>
 </motion.div>
 ...
 {/* ========================================================= */}
 <div 
 className="relative z-30 w-full overflow-hidden border-y border-[#EAEAEA] bg-[#F9F9F8] py-3"
 style={{ WebkitMaskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)", maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}
 >
 ...
 <span
 key={i}
 className="font-mono text-[11px] tracking-[0.15em] uppercase font-bold text-[#787774] px-4"
 >
 {item}
 <span className="text-[#D1D1D1] mx-3">·</span>
 </span>
 ))}
 </div>
 </div>
 ...
 viewport={{ once: false }}
 className="h-full p-7 rounded-2xl minimal-bento-card flex flex-col justify-between group relative overflow-hidden transition-[box-shadow,border-color] duration-300 hover: hover:border-[#2563eb]/30"
 >
 <div className="flex justify-between items-start">
 <div className="w-12 h-12 rounded-xl minimal-bento-card flex items-center justify-center text-[#2E2219] group-hover:text-[#2563eb] group-hover:scale-110 group-hover:drop- transition-all duration-300">
 <Briefcase className="w-5 h-5" />
 </div>
 <span className="px-3 py-1 rounded-xl minimal-inset text-[10px] font-mono font-semibold text-[#5A4839]">
 PRIMARY CONSOLE
 </span>
 </div>
 <div>
 <h3 className="text-xl font-serif font-bold text-[#111111] mb-1 ">Case Management</h3>
 ...
 viewport={{ once: false }}
 className="h-full p-7 rounded-2xl minimal-bento-card flex flex-col justify-between group transition-[box-shadow,border-color] duration-300 hover: hover:border-[#2563eb]/30"
 >
 <div className="w-12 h-12 rounded-xl minimal-bento-card flex items-center justify-center text-[#2E2219] group-hover:text-[#2563eb] group-hover:scale-110 group-hover:drop- transition-all duration-300">
 ...
 <div>
 <h3 className="text-lg font-serif font-bold text-[#111111] mb-1 ">Hearing Prep</h3>
 <p className="text-xs text-[#524337] font-sans leading-relaxed">
 ...
 <div>
 <h3 className="text-lg font-serif font-bold text-[#111111] mb-1 ">Draft Studio</h3>
 <p className="text-xs text-[#524337] font-sans leading-relaxed">
 ...
 <div>
 <h3 className="text-lg font-serif font-bold text-[#111111] mb-1 ">Client Records</h3>
 <p className="text-xs text-[#524337] font-sans leading-relaxed">
 ...
 className="max-w-3xl mx-auto w-full rounded-[20px] minimal-bento-card p-8"
 >
 ...
 transition={{ duration: 0.5, delay: idx * 0.1 }}
 viewport={{ once: false }}
 className="p-8 rounded-2xl minimal-bento-card space-y-3"
 >
 <WhyClausioIcon idx={idx} />
 <h3 className="text-2xl font-serif font-bold text-[#111111] ">{item.title}</h3>
 ...
 className="p-6 rounded-2xl minimal-bento-card flex flex-col items-center text-center cursor-default group"
 >
 {/* Avatar — photo from /public/team, else initials */}
 <TeamAvatar member={member} />

 {/* Name */}
 <h3 className="font-serif font-bold text-[#111111] text-base mb-1">
 {member.name}
 </h3>
 ...
 transition={{ duration: 0.5, delay: idx * 0.1 }}
 viewport={{ once: false }}
 className="p-7 rounded-2xl minimal-bento-card flex flex-col space-y-3"
 >
 <div className="w-11 h-11 rounded-xl minimal-bento-card flex items-center justify-center text-[#0369A1]">
 ...
 className="p-8 md:p-12 rounded-xl minimal-bento-card flex flex-col items-center text-center space-y-5"
 >
 <Scale className="w-6 h-6 text-[#0369A1]" />
 <p className="text-xl md:text-3xl font-serif text-[#111111] leading-snug max-w-3xl">
 ...
 <span key={c} className="px-4 py-2 rounded-xl minimal-inset font-semibold">
 {c}
 </span>
 ))}
 </motion.div>
 ...
 <h2 className="text-5xl md:text-7xl font-serif tracking-tight text-[#111111] leading-[1.05]">
 ...
 <div className="absolute -inset-1 rounded-xl ] ] ] blur-md opacity-40 group-hover:opacity-70 transition duration-1000 animate-pulse" />
 <button
 onClick={() => {
 window.open(SIGNUP_URL, "_blank");
 }}
 ...
 <span className="text-[#111111] font-bold px-2 py-1 rounded minimal-inset cursor-pointer">EN</span>
 </div>
...
function TokenVaultSecuritySection() {
 ...
 <p className="text-base font-sans text-[#787774] leading-relaxed">
 ...
 <div className="relative w-full min-h-[450px] minimal-bento-card rounded-[24px] p-6 md:p-8 flex flex-col lg:flex-row gap-6 items-stretch font-mono">
 
 {/* Pane 1: Clausio Input */}
 <div className="flex-1 bg-white/70 rounded-2xl border border-sky-100 p-5 flex flex-col relative overflow-hidden ">
 <div className="text-[10px] md:text-xs text-[#787774] mb-4 border-b border-slate-200 pb-2 uppercase tracking-widest font-bold flex items-center justify-between">
 ...
 <motion.span 
 className={`font-semibold ${step === 0 ? 'bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded border border-emerald-200 ' : 'text-[#111111]'}`}
 ...
 <motion.span 
 className={`font-semibold ${step === 0 ? 'bg-sky-100 text-sky-800 px-2 py-0.5 rounded border border-sky-200 ' : 'text-[#111111]'}`}
 >
 {currentCase.phone}
 </motion.span>
 </div>
 <div className="h-px w-full bg-slate-200 my-2" />
 <div className="text-[10px] md:text-xs text-[#787774] leading-relaxed italic">
 ...
 animate={{ opacity: 1, x: 0 }}
 exit={{ opacity: 0, x: 20 }}
 className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-8 h-1 bg-[#EDF3EC]0 " 
 />
 )}
 </AnimatePresence>
 </div>
 ...
 {/* Pane 2: Token Vault */}
 <div className="flex-[1.2] bg-[#EBF5FF]/80 rounded-2xl border border-sky-200 p-5 flex flex-col relative minimal-inset">
 <div className="text-[10px] md:text-xs text-[#1F6C9F] mb-4 border-b border-sky-200 pb-2 uppercase tracking-widest font-bold flex items-center justify-between">
 ...
 <div className="bg-white/60 p-3 rounded-lg border border-sky-100 ">
 <div className="text-[#787774] mb-2 text-[10px] uppercase tracking-wider font-bold">Mapping Table:</div>
 
 <div className="space-y-3">
 <div className="flex flex-col lg:flex-row lg:items-center justify-between font-mono gap-1 lg:gap-0">
 <span className="text-[#787774] whitespace-nowrap">{currentCase.name}</span>
 <motion.span 
 ...
 className="whitespace-nowrap font-bold bg-white px-2 py-0.5 rounded border border-slate-100 "
 >
 ...
 <span className="text-[#787774] whitespace-nowrap">{currentCase.phone}</span>
 <motion.span 
 animate={{ opacity: step >= 1 ? 1 : 0.3 }}
 className="text-slate-400 hidden lg:block"
 >→</motion.span>
 ...
 <div className="text-[9px] md:text-[10px] text-sky-600 font-bold text-center uppercase tracking-widest mt-2 h-4 drop-">
 ...
 animate={{ opacity: 1, x: 0 }}
 exit={{ opacity: 0, x: 20 }}
 className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-8 h-1 bg-[#E1F3FE]0 " 
 />
 )}
 </AnimatePresence>
 </div>
 ...
 className="space-y-3"
 >
 <div className="text-[10px] md:text-xs text-[#787774] font-bold mb-2">Prompt Received:</div>
 <div className="bg-[#F8FAFC] p-3 rounded-lg border border-slate-200 text-[9px] md:text-[10px] text-slate-700 leading-relaxed ">
 Draft {currentCase.draftType} for <span className="text-[#346538] font-bold bg-emerald-100 px-1 rounded mx-1 border border-emerald-200">PARTY_1</span>.<br/>
 Contact: <span className="text-[#1F6C9F] font-bold bg-sky-100 px-1 rounded mx-1 border border-sky-200">PHONE_1</span>.
 </div>
 <div className="flex items-center gap-2 mt-4 text-[9px] md:text-[10px] text-[#346538] bg-[#EDF3EC] border border-emerald-200 p-2 rounded justify-center font-bold ">
 ...
 animate={{ opacity: 1, x: 0 }}
 exit={{ opacity: 0, x: 20 }}
 className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-8 h-1 bg-purple-500 " 
 />
 )}
 </AnimatePresence>
 </div>
 ...
 className="space-y-3"
 >
 <div className="text-[10px] md:text-xs text-[#787774] font-bold mb-2">Final Document:</div>
 <div className="bg-[#F8FAFC] p-3 rounded-lg border border-slate-200 text-[9px] md:text-[10px] text-slate-700 leading-relaxed ">
 ...It is respectfully submitted on behalf of the applicant, <span className="text-[#346538] font-bold bg-emerald-100 px-1 rounded border border-emerald-200">
 {currentCase.name}
 </span>, (Contact: <span className="text-[#1F6C9F] font-bold bg-sky-100 px-1 rounded border border-sky-200">{currentCase.phone}</span>)...
 </div>
 </motion.div>
 )}
 </AnimatePresence>
 ...
 <div className="minimal-bento-card rounded-2xl p-6 lg:p-8 flex flex-col gap-4 text-center items-center group">
 <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center text-emerald-600 minimal-inset group-hover:scale-110 transition-transform">
 <ShieldCheck className="w-6 h-6" />
 </div>
 <h4 className="font-serif text-lg font-bold text-[#111111] ">Zero-PII Transmission</h4>
 ...
 <div className="minimal-bento-card rounded-2xl p-6 lg:p-8 flex flex-col gap-4 text-center items-center group">
 <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center text-sky-600 minimal-inset group-hover:scale-110 transition-transform">
 <Database className="w-6 h-6" />
 </div>
 <h4 className="font-serif text-lg font-bold text-[#111111] ">Deterministic Token Vault</h4>
 <p className="text-sm text-[#787774] leading-relaxed">
 ...
 <div className="minimal-bento-card rounded-2xl p-6 lg:p-8 flex flex-col gap-4 text-center items-center group">
 <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center text-purple-600 minimal-inset group-hover:scale-110 transition-transform">
 <Scale className="w-6 h-6" />
 </div>
 <h4 className="font-serif text-lg font-bold text-[#111111] ">DPDP Act 2023 Compliant</h4>
 <p className="text-sm text-[#787774] leading-relaxed">
