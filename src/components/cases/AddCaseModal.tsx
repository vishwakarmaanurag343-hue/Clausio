...
>
Register a new legal matter inside Clausio.
</p>
...
The remaining form adapts automatically.
</p>
...
After selecting the practice area,
Clausio AI will automatically recommend:
...
• Initial Questions
          ...
          {step === 2 && (
            <>
              ...
              <p style={sectionDescription}>
                Enter the basic information about this legal matter.
              </p>
              ...
              <div style={grid}>
                <InputField
                  ...
                  onChange={updateField}
                  placeholder="Priya Sharma vs Rohit Sharma"
                  required
                />
          ...
          {step === 4 && (
            <>
              ...
              <p style={sectionDescription}>
                Provide court, hearing and judicial details.
              </p>
              ...
              >
                ...
                <div style={grid}>
                  ...
                  <InputField
                    label="Court Hall"
                    name="courtHall"
                    value={(form as any).courtHall || ''}
                    onChange={updateField}
                    placeholder="Hall No. 5"
                  />
                </div>
              </div>
            </>
          ...
          {step === 5 && (
            <>
              ...
              <p style={sectionDescription}>
                Upload documents and let Clausio AI analyse the matter.
              </p>
              ...
              >
                ...
                >
                  <AIItem text="Case Summary" />
                  <AIItem text="Timeline of Events" />
                  <AIItem text="Applicable Sections" />
                  <AIItem text="Similar Judgments" />
                  <AIItem text="Missing Documents" />
                  <AIItem text="Risk Analysis" />
                  <AIItem text="Legal Strategy" />
                  <AIItem text="Cross Examination Questions" />
                  <AIItem text="Client Questionnaire" />
                  <AIItem text="Draft Petition Suggestions" />
                </div>
              </div>
              ...
              >
                <TextAreaField
                  ...
                  value={form.relief}
                  onChange={updateField}
                  placeholder="Mention the relief sought from the Court..."
                />
                ...
                <TextAreaField
                  ...
                  value={form.notes}
                  onChange={updateField}
                  placeholder="Private notes for your legal team..."
                />
              </div>
            </>
          )}
          ...
          {step === 6 && (
            <>
              ...
              <p style={sectionDescription}>
                Please verify the information before creating the case.
              </p>
              ...
              >
                ...
                <ReviewSection
                  title="Opponent"
                  items={[
                    ['Opponent', form.opponentName || '-'],
                    ['Advocate', form.opponentAdvocate || '-'],
                  ]}
                />
                ...
                <ReviewSection
                  ...
                  items={[
                    ['Court', form.court || '-'],
                    ['Location', form.courtLocation || '-'],
                    ['Judge', form.judgeName || '-'],
                    ['Stage', form.stage || '-'],
                  ]}
                />
              ...
              >
                ...
                >
                  🤖 Clausio AI will automatically generate
                </h4>
